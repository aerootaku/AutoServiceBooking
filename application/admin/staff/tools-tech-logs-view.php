    ...
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                <h3 class="text-info" style="text-align: center"><center>Transaction History</center></h3>
                <div class="row">

                    <?php
                    $xid = $_SESSION['id'];
                    $value = db_select_whereCustom('tbl_booking', $data = array("company_name"=>$_SESSION['company_name'], "tech_id"=>$_GET['tech_id']));
                    if($value->rowCount()>0)
                    {
                        while($row=$value->fetch(PDO::FETCH_ASSOC))
                        {
                            ...
                            <div class="col-md-6">
                                <div class="card card-accent-theme">
                                    <div class="card-body">
                                        <h4 class="text-theme"><?= $row['company_name']; ?></h4>
                                        <h5>Customer Name: <strong><?= $row['customer_firstname']. " ". $row['customer_lastname'];
                                        ?></strong></h5>
                                        <span>Service Type: <strong><?= $row['service_type']; ?></strong></span><br />
                                        <span>Service Fee: <strong><?= $row['fee']; ?></strong></span><br />
                                        <span>Assigned Technician: <strong> <?= $row['tech_firstname'] ." ". $row['tech_lastname'];
                                                ?></strong></span><br />
                                        <span>Status: <strong> <?= $row['status']; ?></strong></span><br />
                                    </div>
                                    <!-- end-card-body -->
                                </div>
                                <!-- end card -->
