...
if(isset($_POST['accept'])){
    ...
    if(isset($query)){
        $insert = db_insert('tbl_msg', $datas = array("msg_info"=>"Reservation has been accepted, Please Expect our Arrival Soon", "user_id"=>$_GET['client_id']));
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Finished Reservation</h4>
                    ...
                    <form action="?id=<?=$row['id']; ?>&client_id=<?= $row['client_id']; ?>" method="POST" id="needs-validation" novalidate="" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $row['res_date']; ?>" readonly />
                            </div>
                            <div class="form-group">
                                <label>Time Reserved</label>
                                <input type="text" class="form-control" value="<?= date('h:i:a', strtotime($row['res_time'])); ?>" readonly/>
                            </div>
