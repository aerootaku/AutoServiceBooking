...
if(isset($_POST['create'])){
    ...
    if(isset($query)){
        ...
        $action->redirect('management-admin.php?Success');
    }
    else{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">USER MANAGEMENT</h4>
                                ...
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" width="100%">
                                    ...
                                    <?php
                                    $xid = $_SESSION['id'];
                                    $value = custom_query("SELECT * FROM tbl_company_users WHERE company_name ='$company_name' and role ='Staff' and id!='$xid'");
                                    if($value->rowCount()>0)
                                    {
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select name="services" class="form-control">
                                    <?php
                                    $value = custom_query("SELECT * FROM tbl_services WHERE company_name = '$company_name'");
                                    if($value->rowCount()>0)
                                    {
                                        while($row=$value->fetch(PDO::FETCH_ASSOC))
                                        {
