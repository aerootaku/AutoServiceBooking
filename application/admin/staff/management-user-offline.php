                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                ...
                                <a href="management-user.php" class="btn
                                            btn-dark" title="All Technician Records">All Technician</a>
                                ...
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $value = custom_query("SELECT * FROM tbl_company_users WHERE company_name ='$company_name' and role ='Tech' and isOnline = 'Offline'");
                                    if($value->rowCount()>0)
                                    {
