                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Technician Transaction Logs</h4>
<!--                                <button type="button" data-toggle="modal" data-target="#add" class="btn-->
<!--                                            btn-dark">Create Services</button>-->
                                <br /><hr />
                                ...
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $value = custom_query("SELECT id, tech_id, COUNT(tech_id) as service, tech_firstname, tech_lastname FROM tbl_booking WHERE company_name = '$company_name' GROUP BY tech_id");
                                    if($value->rowCount()>0)
                                    {
...
//                                            echo $row['tech_id'];
                                            ?>
                                            <tr>
                                                <td><?php echo $row['tech_firstname']. " ". $row['tech_lastname']; ?></td>
                                                <td><?= $row['service']; ?></td>
...
<!--                                                    btn-xs-->
<!--                                                    btn-warning" style="margin-top: -5px"><i class="icon-eye"-->
<!--                                                                                             style="color: black;"></i> </a>-->
                                                    <a href="tools-tech-logs-view.php?tech_id=<?php echo $row['tech_id']; ?>" class="btn
                                                    btn-xs
                                                    btn-warning" style="margin-top: -5px" title="View Transaction"><i class="icon-eye"
                                                                                             style="color: black;" ></i> </a>
                    ...
                    <form action="?id=<?=$row['id']; ?>" method="POST" id="needs-validation" novalidate="" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control">
                                    <?php
                                    $value1 = db_select_whereCustom('tbl_category', $data = array('company_name'=>$_SESSION['company_name']));
