...
if(isset($_POST['create'])){
    ...
    , "fee"=>$_POST['fee'], "category"=>$_POST['category']);
...
if(isset($_POST['edit'])){
    $id = $_GET['id'];
    $data = array(
        "title"=>$_POST['title'], "description"=>$_POST['description'], "category"=>$_POST['category'], "fee"=>$_POST['fee']
    );
    $where = array("id"=>$id);
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Manage Services</h4>
                                <button type="button" data-toggle="modal" data-target="#add" class="btn
                                            btn-dark" title="Create New Category">Create Services</button>
                                <a href="services-booking.php" class="btn
                                            btn-warning" title="Create New Category">Booking Services</a>
                                <a href="services-reservation.php" class="btn
                                            btn-danger" title="Create New Category">Reservation Services</a>
                                ...
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $value = db_select_whereCustom('tbl_services', $data = array("company_name"=>$company_name, "category"=>"Reservation"));
                                    if($value->rowCount()>0)
                                    {
                                        while($row=$value->fetch(PDO::FETCH_ASSOC))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['category']; ?></td>
                                                <td>
                                                    <a data-target="#edit<?= $id; ?>" data-toggle="modal" class="btn
                                                    btn-xs
                                                    btn-warning" style="margin-top: -5px" title="Edit Service"><i class="icon-pencil"
                                                                                                                  style="color: black;"></i> </a>
                                                    <a data-target="#delete<?= $id; ?>" data-toggle="modal" class="btn
                                                    btn-xs  btn-danger" style="margin-top: -5px" title="Delete Service"><i class="icon-trash"
                                                                                                                           style="color: white;"></i>
                                                    </a>
