...
if(isset($_POST['edit'])){
    $id = $_GET['id'];
    $data = array ("firstname"=>$_POST['firstname'], "lastname"=>$_POST['lastname'], "email"=>$_POST['email'], "contact"=>$_POST['contact']);
    $where = array("id"=>$id);
    $query = db_update('tbl_company_users', $data, $where);
    if(isset($query)){
        $action->redirect('users.php?Success');
    }
    else{
        $error = "There was an error in your action";
    }
...
<!--                                        <th>Action</th>-->
                                    ...
                                    <tbody>
                                    <?php
                                    $value = db_select_whereCustom('tbl_company_users', $data = array("role"=>"Admin"));
                                    if($value->rowCount()>0)
                                    {
                                        while($row=$value->fetch(PDO::FETCH_ASSOC))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['contact']; ?></td>
                                                <td>
                                                    <a href="" data-target="#edit<?= $id; ?>" data-toggle="modal" class="btn btn-xs btn-warning" style="margin-top: -5px" title="Edit Record"><i class="icon-pencil"
                                                                                             style="color: black;"></i> </a>
                                                    <a href="" data-target="#delete<?= $id; ?>" data-toggle="modal" class="btn btn-xs btn-danger" style="margin-top: -5px" title="Delete Record" ><i class="icon-trash"
                                                                                                    style="color: white;"></i>
                                                    </a>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="validationCustom05"
                               ...
                               required="" name="description" maxlength="100"/>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="validationCustom05" placeholder="+639* *** ****" class="masked" 
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" 
                               autocomplete="new-password" min="8" max="16" required />
                        <div class="invalid-feedback">
                            Please provide a valid password.
                        </div>
                    </div>
                    ...
                    <form action="?id=<?=$row['id']; ?>" method="POST" id="needs-validation" novalidate="" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="validationCustom05">Company Name</label>
                                <input type="text" class="form-control" id="validationCustom05" placeholder="Company Name"
                                       required="" name="name" value="<?= $row['company_name']; ?>" readonly />
                                <div class="invalid-feedback">
                                    Please provide a valid name.
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom05">Mobile Number</label>
                                <input type="number" class="form-control" id="validationCustom05" placeholder="Mobile Number"
