...
<body>
    <section class="container-pages">
        ...
        <div class="card pages-card col-lg-4 col-md-6 col-sm-6">
            <div class="card-body ">
                <div class="h4 text-center text-theme"><strong>Auto Service</strong></div>
                    ...
                    <form action="" method="post" id="needs-validation" novalidate="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-right">
                                <small>
                                    <a href="forgot-password.php" class="text-theme">Forgot Password?</a>
                                </small>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    <small>Don't you have an account ? Please
                        <a href="signup.php" class="text-theme">Sign up</a>
                    </small>
                </div>
