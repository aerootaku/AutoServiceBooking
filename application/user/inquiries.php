...
if(isset($_POST['send'])){
    $query = db_insert('tbl_customer_concern', $data = array("customer_id"=>$_SESSION['id'],
        "firstname"=>$_SESSION['firstname'], "middlename"=>$_SESSION['middlename'],
        "lastname"=>$_SESSION['lastname'], "company_name"=>$_POST['company'], "feedback"=>$_POST['feedback'], "suggestions"=>$_POST['suggestion']));
    if(isset($query)){
        $action->redirect('inquiries.php?Success');
    }
    else{
                ...
                <div class="row">
                            <div class="col-md-6">
                                <div class="card card-accent-theme">
                                    <div class="card-body">
                                        <h4 class="text-theme">Send your Feedback & Suggestions</h4>
                                        <form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="suggestion" class="form-control" rows="5"></textarea>
                                            </div>
                                            <div class="form-group">
