...
if(isset($_POST['register'])){
    ...
    $data = array("username"=> $_POST['username'], "password"=>$new_password, "firstname"=>$_POST['firstname'], "middlename"=>$_POST['middlename'],
        "lastname"=>$_POST['lastname'], "address"=>$_POST['address'], "email"=>$_POST['email'], "contact"=>$_POST['contact'], "status"=>"Active");
    $_SESSION['code'] = date('ymhis');
    $query = db_insert('tbl_users', $data);
    if(isset($query)){
        $to = $_POST['email'];
        $subject = "Welcome";
        $message = "Thank you for Registering at Auto Service!";
        $headers = "From: no-reply@autoservice-web.xyz";
        mail($to,$subject,$message,$headers);
        $action->redirect('verify.php?Success');
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="password" class="form-control"
                                       placeholder="Password" min="8" max="16" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" id="password" name="contact" class="form-control" value="+639"
                                       placeholder="Contact Number" maxlength="13" required  />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon text-theme"><i class="fa fa-id-card"></i></span>
                                <textarea id="password" name="address" class="form-control"
