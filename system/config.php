...
function db_connect(){
//    $DB_host = "mysql.hostinger.ph";
//    $DB_user = "u434449709_web";
//    $DB_pass = "autoservice";
//    $DB_name = "u434449709_web";
...
function db_count_whereCustom($tableName, $where){
    $db = db_connect();
    $stringWhere = "";
    $array = array();
    $count = 0;
...
function db_select_whereCustom($tableName,$where){
    $db = db_connect();
    $stringWhere = "";
    $array = array();
